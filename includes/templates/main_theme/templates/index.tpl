...
<div id="main">
	 <div id="top" style="background-color: #1866af"></div>
	
	<div id="header">
		<div align="center" style="color: #1866af">
			<p><a href="http://www.avantfax.com" target="_blank"><img
							src="images/clarity-logo-xl.png" border="0" alt="AvantFAX" /></a></p>
			Fax Login
		</div>
...
{/if}
	...
	<div id="bottom" style="background-color: #1866af"></div>
</div>
